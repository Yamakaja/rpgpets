package me.yamakaja.rpgpets.v1_12_R1.pathfinding;
...
public class PetPathfinderGoalOwnerHurtTarget extends PathfinderGoalTarget {
    ...
    public boolean a() {
        ...
        this.target = nmsPlayer.bU(); // getLastAttackedEntity

        int lastAttackedEntityTime = nmsPlayer.bV(); // getLastAttackedEntityTime
        return lastAttackedEntityTime != this.c && this.a(this.target, false);
    }
